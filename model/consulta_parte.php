...
class ModeloConsultaParte{
	...
	function ModeloConsultaParte() { //Constructor de la clase del modelo
		$this->base_datos = new medoo();
	}
	function consultar_parte($parte){
		$partes = $this->base_datos->select("parte" , "*" , ["num_parte" => $parte]);
		return $partes;
	}
}
